...
static struct armada_thermal_data armada_ap806_data = {
...
static struct armada_thermal_data armada_ap807_data = {
	.init = armada_ap80x_init,
	.is_valid_bit = BIT(16),
	.temp_shift = 0,
	.temp_mask = 0x3ff,
					 ...
					 int sensor_id)
{
	...
	if (THERMAL_SUPPORTED_IN_FIRMWARE(priv)) {
		 ...
		 * step.
		 */
		return armada_fw_overheat_settings(priv, temperature, 0);
	}
